...
# Exemplo de teste (remover antes de entregar, se for o caso)
if __name__ == "__main__":
    try:
        print(calcular("00000101", "00000011", "-")),  # Esperado: 00000010
        print(calcular("00000101", "00000011", "x")),  # Esperado: 00001111
        print(calcular("00000101", "00000011", "+")),  # Esperado: 00001000
        print(calcular("00001010", "11111110", "x")),  # Esperado: 11101100
        print(calcular("00000001", "00000010", "+")),  # Esperado: 00000011
        print(calcular("01111111", "00000001", "+")),  # Esperado: Overflow
